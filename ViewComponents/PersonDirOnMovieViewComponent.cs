...
{
    public class PersonDirOnMovieViewComponent : ViewComponent
    {

        public ApplicationDbContext _context { get; }

        public PersonDirOnMovieViewComponent(ApplicationDbContext dbcontext)
        {
            _context = dbcontext;
        }
        ...
        {
            var personIds = _context.PerMovDir.AsQueryable().Where(t => t.MovieKey == movie).Select(p => p.PersonKey);
